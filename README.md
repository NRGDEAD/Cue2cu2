...
optional arguments:
  ...
  -nc, --nocompat       Disables compatibility mode, produces a CU2 sheet without offset correction.
  -c, --compat          Enables compatibility mode, aims to be bit-identical to what Systems Console
			would produce. This is the default mode.
  -1, --stdout          Output to stdout instead of a CU2 file named after the binary image file
  -s SIZE, --size SIZE  Manually specify binary filesize in bytes instead of obtaining it from the
			binary file
  ...
  -o OFFSET, --offset OFFSET
			...
			Example: -o=-00:13:37.
			Note: resulting output range is limited to 00:00:00 - 99:59:74 and will be
			clipped if either boundary is crossed.
